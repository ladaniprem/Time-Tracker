...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-ring/50 focus-visible:ring-offset-0 transition-all duration-150 active:scale-[0.98] active:translate-y-[1px]",
  {
    variants: {
      variant: {
        default:
        ...
        outline:
          "border bg-background/50 shadow-sm hover:bg-muted/60 hover:text-foreground dark:border-input",
        secondary:
